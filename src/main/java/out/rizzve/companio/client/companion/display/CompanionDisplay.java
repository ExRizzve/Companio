...
public final class CompanionDisplay {
    ...
    public void spawn(ClientLevel level, Vec3 position, float yaw, GameProfile profile) {
        ...
        if (profile != null) item.set(DataComponents.PROFILE, ProfileCompat.resolvable(profile));
        head = new Display.ItemDisplay(DisplayTypes.itemDisplay(), level);
    ...
    private void refreshName() {
        ...
        name = new Display.TextDisplay(DisplayTypes.textDisplay(), level);
